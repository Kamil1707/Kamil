            ...
            public string Login {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Login\' in table \'auth\' is DBNull.", e);
                    }
                }
                set {
...
namespace WindowsFormsApp1.authDataSetTableAdapters {
    ...
    public partial class authTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `auth` WHERE ((`ID` = ?) AND ((? = 1 AND `Login` IS NULL) OR (`Login`" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `auth` (`Login`, `Password`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `auth` SET `Login` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.authConnectionString;
        }
